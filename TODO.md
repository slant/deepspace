...
- [x] ~~**Track uses**~~ — not applicable. Spending a *use* of a completed upgrade's effect happens entirely during physical combat the app never sees (see Combat section above) — nothing for the app to track here, same as hull/shield.
